...
//         issued: [
//             {
//                 'date-parts': ["2017", "12", "30"]
//             }
//         ],
//         'container-title': "La Revista de Pepe",
//         volume: "1",
//         issue: "1",
//         page: "1-2"
//     }
...
function reloadCitations(){
    ...
    loadCitations().then(function (objects) {
...
function loadCitations(articleId){
    ...
    return $.getJSON(citationsApiUrl+'/citations').then(function (data) {
        return data.data;
    });
